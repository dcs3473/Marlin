...
#define STRING_CONFIG_H_AUTHOR "(DCS, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "dcsEnder-3 4.2.7"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -65, -35, 0 }
...
#define Z_PROBE_SPEED_FAST (166*60)
